import{j as t}from"./index-_eCCCJMN.js";/* empty css                  */import{G as h,a as g}from"./GridUpdatingContextProvider-DK2uKtWm.js";import"./stateDeferredHook-9sbfsEJK.js";import{r as o}from"./index-ne9I_3bB.js";import{G as p,M as w}from"./Grid-BnijaEma.js";import{G as a,n as x,e as b,a as f,b as G,c as y,d as S,i as I,j as v,u as C,o as T,f as F,g as R}from"./GridWrapper-DVhisWkQ.js";import{w as r}from"./util-DX3mDqFH.js";import{G as D}from"./GridPopoverMessage-uiwko0Uh.js";import"./ActionButton-CwNE6oAT.js";import{w as j}from"./storybookTestUtil-B6V3sqEj.js";import"./index-JPfhvaY4.js";import"./index-DJy14G1K.js";const W={title:"Components / Grids",component:p,args:{quickFilter:!0,quickFilterValue:"",quickFilterPlaceholder:"Quick filter...",selectable:!1,rowSelection:"single"},parameters:{docs:{source:{type:"code"}}},decorators:[i=>t.jsx("div",{style:{maxWidth:1024,height:400,display:"flex",flexDirection:"column"},children:t.jsx(h,{children:t.jsx(g,{children:t.jsx(i,{})})})})]},O=i=>{const[l,d]=o.useState([]),c=o.useMemo(()=>[a({field:"id",headerName:"Id",lockVisible:!0}),a({field:"position",headerName:"Position",cellRendererParams:{warning:({value:e})=>e==="Tester"&&"Testers are testing",info:({value:e})=>e==="Developer"&&"Developers are awesome"}}),{headerName:"Metrics",marryChildren:!0,children:[a({field:"age",headerName:"Age"}),a({field:"height",headerName:"Height"})]},a({field:"desc",headerName:"Description",flex:1,initialHide:!0}),x(),D({headerName:"Popout message",cellRenderer:()=>t.jsx(t.Fragment,{children:"Single Click me!"}),exportable:!1},{multiEdit:!0,editorParams:{message:async e=>(await r(1e3),`There are ${e.length} row(s) selected`)}}),a({headerName:"Custom edit",editable:!0,flex:1,valueFormatter:()=>"Press E",cellRendererParams:{rightHoverElement:t.jsx(T,{icon:"ic_launch_modal",title:"Title text",className:"GridCell-editableIcon"}),editAction:e=>{alert(`Custom edit ${e.map(n=>n.id).join()} rowId(s) selected`)},shortcutKeys:{e:()=>{alert("Hi")}}}}),b({},{multiEdit:!0,editorParams:{defaultAction:({menuOption:e})=>{console.log("clicked",{menuOption:e})},options:async e=>(await r(500),[{label:"Single edit only",action:async({selectedRows:n})=>{alert(`Single-edit: ${n.map(m=>m.id).join()} rowId(s) selected`),await r(1500)},disabled:e.length>1},{label:"Multi-edit",action:async({selectedRows:n})=>{alert(`Multi-edit: ${n.map(m=>m.id).join()} rowId(s) selected`),await r(1500)}},{label:"Sub menu...",subMenu:()=>t.jsx(w,{children:"Find..."})},{label:"Disabled item",disabled:"Disabled for test"},{label:"Developer Only",hidden:e.some(n=>n.position!="Developer")},{label:"Other (TextInput)",action:async({menuOption:n})=>{console.log(`Sub selected value was ${JSON.stringify(n.subValue)}`),await r(500)},subComponent:()=>t.jsx(F,{placeholder:"Other",maxLength:5,required:!0,defaultValue:""})},{label:"Other (TextArea)",action:async({menuOption:n})=>{console.log(`Sub selected value was ${JSON.stringify(n.subValue)}`),await r(500)},subComponent:()=>t.jsx(R,{placeholder:"Other",maxLength:5,required:!0,defaultValue:""})}])}})],[]),[u]=o.useState([{id:1e3,position:"Tester",age:30,height:`6'4"`,desc:"Tests application",dd:"1"},{id:1001,position:"Developer",age:12,height:`5'3"`,desc:"Develops application",dd:"2"},{id:1002,position:"Manager",age:65,height:`5'9"`,desc:"Manages",dd:"3"}]);return t.jsxs(f,{maxHeight:400,children:[t.jsxs(G,{children:[t.jsx(y,{}),t.jsx(N,{text:"Age <",field:"age"}),t.jsx(S,{luiButtonProps:{style:{whiteSpace:"nowrap"}},options:[{label:"All"},{label:"< 30",filter:e=>e.age<30}]}),t.jsx(I,{}),t.jsx(v,{fileName:"readOnlyGrid"})]}),t.jsx(p,{"data-testid":"readonly",...i,selectable:!0,autoSelectFirstRow:!0,externalSelectedItems:l,setExternalSelectedItems:d,columnDefs:c,rowData:u})]})},N=i=>{const[l,d]=o.useState(),c=o.useCallback(e=>l==null||e[i.field]<l,[i.field,l]);C(c);const u=e=>{try{d(e.trim()==""?void 0:parseInt(e))}catch{}};return t.jsxs("div",{className:"GridFilter-container flex-row-center",children:[t.jsx("div",{style:{whiteSpace:"nowrap"},children:i.text})," ",t.jsx("input",{type:"text",defaultValue:l,onChange:e=>u(e.target.value),style:{width:64}})]})},s=O.bind({});s.play=j;s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`(props: GridProps) => {
