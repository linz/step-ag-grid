...
const Template: StoryFn<typeof GridFormDropDown> = (props: GridFormDropDownProps<GridBaseRow, any>) => {
  const configs: [string, GridFormDropDownProps<GridBaseRow, any>, string?][] = [
    ['No options', { options: [] }],
