import{j as a}from"./jsx-runtime-DEdD30eg.js";/* empty css                  */import{G,a as D}from"./GridUpdatingContextProvider-C0OJ_AZp.js";import"./stateDeferredHook-DIITot2w.js";import{r as l}from"./index-RYns6xqu.js";import{G as m,w as P,x as g,k as R}from"./GridWrapper-y58xtKL0.js";import{G as w,b as C}from"./Grid-osFtHP2O.js";import"./index-DYmNCwer.js";import{w as s,h as S}from"./util-CWqzvxZb.js";import{G as T}from"./GridFormTextArea-teTdy3sf.js";import{G as I}from"./GridPopoverMenu-Dgdhx-D_.js";import{G as y}from"./GridPopoverTextArea-DOidEkl6.js";import{G as b}from"./GridFormTextInput-aXxoJHW9.js";import{A as F}from"./ActionButton-BnaFCZwL.js";import{w as A}from"./storybookTestUtil-CYGWFEhE.js";import"./GridFormPopoverMenu-DyaAWYt_.js";import"./index-8uelxQvJ.js";const c=n=>({component:g(n.editor),params:{...n.editorParams,multiEdit:n.multiEdit}}),N=(n,i)=>m({cellClassRules:P,cellEditorSelector:i,editable:n.editable??!0,...n}),p=(n,i)=>m(n,{editor:b,...i}),Y={title:"Components / Grids",component:w,args:{quickFilterValue:"",selectable:!0},decorators:[n=>a.jsx("div",{style:{width:1024,height:400},children:a.jsx(G,{children:a.jsx(D,{children:a.jsx(n,{})})})})]},_=n=>{const{selectRowsWithFlashDiff:i}=l.useContext(C),[h,f]=l.useState([]),[r,u]=l.useState([{id:1e3,name:"IS IS DP12345",nameType:"IS",numba:"IX",plan:"DP 12345",distance:10},{id:1001,name:"PEG V SD523",nameType:"PEG",numba:"V",plan:"SD 523",distance:null}]),x=l.useMemo(()=>[m({field:"id",headerName:"Id"}),p({field:"name",headerName:"Text input"},{multiEdit:!0,editorParams:{required:!0,maxLength:12,placeholder:"Enter some text...",invalid:e=>e==="never"?"The value 'never' is not allowed":null,onSave:async({selectedRows:e,value:t})=>(await s(1e3),e.forEach(o=>o.name=t),!0)}}),p({field:"distance",headerName:"Number input",valueFormatter:e=>{const t=e.data?.distance;return t!=null?`${t}${e.colDef.cellEditorParams.units}`:"–"}},{multiEdit:!1,editorParams:{maxLength:12,placeholder:"Enter distance...",units:"m",invalid:e=>e.length&&!S(e)?"Value must be a number":null,onSave:async({selectedRows:e,value:t})=>(await s(1e3),e.forEach(o=>o.distance=t.length?parseFloat(t):null),!0)}}),y({field:"plan",headerName:"Text area"},{multiEdit:!0,editorParams:{required:!0,maxLength:32,placeholder:"Enter some text...",invalid:e=>e==="never"?"The value 'never' is not allowed":null,onSave:async({selectedRows:e,value:t})=>(await s(1e3),e.forEach(o=>o.plan=t),!0)}}),N({colId:"plan2",field:"plan",headerName:"Multi-editor"},e=>e.rowIndex==0?c({multiEdit:!0,editor:T,editorParams:{required:!0,maxLength:32,placeholder:"Enter some text..."}}):c({multiEdit:!1,editor:R,editorParams:{options:[{label:"One",value:1}]}})),I({headerName:""},{multiEdit:!0,editorParams:{options:async e=>[{label:"Delete",action:async({selectedRows:t})=>{await s(1e3),u(r.filter(o=>!t.some(E=>E.id==o.id)))}}]}})],[r]),v=l.useCallback(async()=>{await s(1e3);const e=r[r.length-1];await i(async()=>{u([...r,{id:(e?.id??0)+1,name:"?",nameType:"?",numba:"?",plan:"",distance:null}])})},[r,i]);return a.jsxs(a.Fragment,{children:[a.jsx(w,{...n,externalSelectedItems:h,setExternalSelectedItems:f,columnDefs:x,rowData:r,domLayout:"autoHeight",defaultColDef:{minWidth:70},sizeColumns:"auto",onCellEditingComplete:()=>{console.log("Cell editing complete")}}),a.jsx(F,{icon:"ic_add",name:"Add new row",inProgressName:"Adding...",onClick:v})]})},d=_.bind({});d.play=A;d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`(props: GridProps) => {
  const {
...
}`,...d.parameters?.docs?.source}}};const Z=["_EditGenericTextArea"];export{d as _EditGenericTextArea,Z as __namedExportsOrder,Y as default};
