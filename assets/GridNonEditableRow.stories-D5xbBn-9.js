import{j as t,w as n}from"./util-eZhZbfsr.js";/* empty css                  */import{G as l,e as f,p as b,f as g,g as h}from"./GridWrapper-BQp-g5Ca.js";import"./stateDeferredHook-DITQGBk8.js";import{G as x}from"./GridPopoverEditDropDown-DXWQtAdO.js";import{G as S}from"./GridPopoverTextArea-BsOR17cl.js";import{r as i}from"./iframe-DPaswKtK.js";import{G as d}from"./Grid-rACfpCEn.js";import{G as D,a as G}from"./GridUpdatingContextProvider-QXyZC2KO.js";import"./ActionButton-DvHFrPXG.js";import{w as v}from"./storybookTestUtil-D13wlVSp.js";import"./index-DlFCgIiE.js";import"./preload-helper-Ct5FWWRu.js";const $={title:"Components / Grids",component:d,args:{selectable:!0,rowSelection:"single",autoSelectFirstRow:!0},decorators:[r=>t.jsx("div",{style:{width:1024,height:400},children:t.jsx(D,{children:t.jsx(G,{children:t.jsx(r,{})})})})]},y=r=>{const[c,p]=i.useState([]),m=i.useMemo(()=>[l({field:"id",headerName:"Id"}),x({field:"position",headerName:"Position"},{multiEdit:!0,editorParams:{filtered:"local",filterPlaceholder:"Filter",options:["Architect","Developer","Product Owner","Scrum Master","Tester"].map(b)}}),l({field:"age",headerName:"Age"}),S({field:"desc",headerName:"Description"},{}),f({},{multiEdit:!0,editorParams:{options:async a=>(await n(500),[{label:"Single edit only",action:async({selectedRows:e})=>{alert(`Single-edit: ${e.map(s=>s.id).join()} rowId(s) selected`),await n(1500)},disabled:a.length>1},{label:"Multi-edit",action:async({selectedRows:e})=>{alert(`Multi-edit: ${e.map(s=>s.id).join()} rowId(s) selected`),await n(1500)}},{label:"Disabled item",disabled:"Disabled for test"},{label:"Developer Only",hidden:a.some(e=>e.position!="Developer")},{label:"Other (TextInput)",action:async({menuOption:e})=>{console.log(`Sub selected value was ${JSON.stringify(e.subValue)}`),await n(500)},subComponent:()=>t.jsx(g,{placeholder:"Other",maxLength:5,required:!0,defaultValue:""})},{label:"Other (TextArea)",action:async({menuOption:e})=>{console.log(`Sub selected value was ${JSON.stringify(e.subValue)}`),await n(500)},subComponent:()=>t.jsx(h,{placeholder:"Other",maxLength:5,required:!0,defaultValue:""})}])}})],[]),[u]=i.useState([{id:1e3,position:"Tester",age:30,desc:"Tests application",dd:"1"},{id:1001,position:"Developer",age:12,desc:"Develops application",dd:"2"},{id:1002,position:"Manager",age:65,desc:"Manages",dd:"3"}]),w=i.useMemo(()=>({editable:({data:a})=>a?.position!=="Manager"}),[]);return t.jsx(d,{...r,externalSelectedItems:c,setExternalSelectedItems:p,defaultColDef:w,columnDefs:m,rowData:u,domLayout:"autoHeight"})},o=y.bind({});o.play=v;o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`(props: GridProps) => {
